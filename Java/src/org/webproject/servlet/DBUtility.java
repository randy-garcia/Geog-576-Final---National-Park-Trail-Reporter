...
public class DBUtility {
    ...
    private static final String ConnUrl = "jdbc:postgresql://localhost:5432/npr";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        // 1. create a user
        util.modifyDB("insert into placepoint (type. name, notes) values ('test_user_1_fN', 'test_user_1_lN')");

        // 2. query the database
        ResultSet res = util.queryDB("select * from report");
        while (res.next()) {
            System.out.println("Report Type: "+res.getString("report_type"));
        }
